...
use {
    crate::state::Fee, trezoa_pubkey::Pubkey, trezoa_stake_interface::state::Meta,
    std::num::NonZeroU32,
};
...
trezoa_pubkey::declare_id!("SPoo1Ku8WFXoNDMHPsrGSTSG1Y47rzgn41SLUNakuHy");
/// Program id for devnet
pub mod devnet {
    trezoa_pubkey::declare_id!("DPoo15wWDqpPJJtS2MUZ49aRxqz5ZaaJCJP4z8bLuib");
}
