...
use {
    ...
    trezoa_clock::{Clock, Epoch},
    trezoa_cpi::{invoke, invoke_signed},
...
/// Check tpl metadata account address for the pool mint
...
impl Processor {
    ...
    /// Issue a TPL Token `Burn` instruction.
    #[allow(clippy::too_many_arguments)]
    fn token_burn<'a>(
        ...
        let ix = tpl_token_2022_interface::instruction::burn(
            token_program.key,
            burn_account.key,
            mint.key,
            authority.key,
    ...
    /// Issue a TPL Token `MintTo` instruction.
    #[allow(clippy::too_many_arguments)]
    fn token_mint_to<'a>(
        stake_pool: &Pubkey,
        token_program: AccountInfo<'a>,
        ...
        let ix = tpl_token_2022_interface::instruction::mint_to(
            token_program.key,
            mint.key,
            destination.key,
            authority.key,
    ...
    /// Issue a TPL Token `Transfer` instruction.
    #[allow(clippy::too_many_arguments)]
    fn token_transfer<'a>(
        token_program: AccountInfo<'a>,
        ...
        let ix = tpl_token_2022_interface::instruction::transfer_checked(
            token_program.key,
            source.key,
            mint.key,
            destination.key,
    ...
    fn process_initialize(
        ...
        check_tpl_token_program_account(token_program_info.key)?;
    ...
    fn process_withdraw_stake(
        ...
        let validator_list_item_info = if *stake_split_from.key == stake_pool.reserve_stake {
            ...
            {
                msg!("Attempting to withdraw {} lamports, maximum possible TRZ withdrawal is {} lamports",
                    withdraw_lamports,
