//! Inline TPL metadata types to avoid a direct dependency on
//! `tpl-token-metadata' NOTE: this file is sym-linked in `tpl-single-pool`, so
//! be careful with changes!

trezoa_pubkey::declare_id!("metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s");
...
pub mod pda {
    use {super::ID, trezoa_pubkey::Pubkey};
