...
pub enum StakePoolError {
    ...
    /// Provided trz deposit authority does not match the program's
    ...
    /// Provided trz withdraw authority does not match the program's
...
impl ToStr for StakePoolError {
    fn to_str(&self) -> &'static str {
        match self {
            ...
            Self::InvalidSolDepositAuthority => "Error: Provided trz deposit authority does not match the program's",
            ...
            Self::InvalidSolWithdrawAuthority => "Error: Provided trz withdraw authority does not match the program's",

            // 35.
            Self::SolWithdrawalTooLarge => "Error: Too much TRZ withdrawn from the stake pool's reserve account",
            ...
            // 40.
            Self::IncorrectMintDecimals => "Error: Provided mint does not have 9 decimals to match TRZ",
            Self::ReserveDepleted => "Error: Pool reserve does not have enough lamports to fund rent-exempt reserve in split destination. Deposit more TRZ in reserve, or pre-fund split destination with the rent-exempt reserve for a stake account.",
