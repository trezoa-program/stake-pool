...
if __name__ == "__main__":
    ...
    parser.add_argument('reserve_amount', metavar='RESERVE_AMOUNT', type=float,
                        help='Amount of TRZ to keep in the reserve, e.g. 10.5')
    parser.add_argument('--endpoint', metavar='ENDPOINT_URL', type=str,
                        default='https://api.mainnet-beta.trezoa.com',
                        help='RPC endpoint to use, e.g. https://api.mainnet-beta.trezoa.com')
    ...
    print(f'Amount to leave in the reserve: {args.reserve_amount} TRZ')
