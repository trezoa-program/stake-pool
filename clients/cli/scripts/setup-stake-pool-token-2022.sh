...
# Withdrawal fee for TRZ and stake accounts, represented as `numerator / denominator`
command_args+=( --withdrawal-fee-numerator 2 )
command_args+=( --withdrawal-fee-denominator 100 )

# Deposit fee for TRZ and stake accounts, represented as `numerator / denominator`
...
tpl-token create-token --program-2022 "$mint_keyfile"
...
echo "Depositing TRZ into stake pool"
$spl_stake_pool deposit-trz "$stake_pool_pubkey" "$sol_amount"
