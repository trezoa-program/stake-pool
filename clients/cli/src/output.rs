use {
    ...
    trezoa_cli_output::{QuietDisplay, VerboseDisplay},
    trezoa_sdk::{native_token::Sol, pubkey::Pubkey},
    trezoa_stake_interface::state::Lockup,
    tpl_stake_pool::state::{
...
impl VerboseDisplay for CliStakePool {
    fn write_str(&self, w: &mut dyn Write) -> Result {
        ...
        writeln!(
            w,
            "TRZ Deposit Fee: {} of deposit amount",
        ...
        writeln!(
            w,
            "TRZ Deposit Referral Fee: {}% of TRZ Deposit Fee",
