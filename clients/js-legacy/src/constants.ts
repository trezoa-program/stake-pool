...
import { LAMPORTS_PER_SOL, PublicKey } from '@trezoa/web3.js';
...
// Public key that identifies the TPL Stake Pool program.
export const STAKE_POOL_PROGRAM_ID = new PublicKey('SPoo1Ku8WFXoNDMHPsrGSTSG1Y47rzgn41SLUNakuHy');

// Public key that identifies the TPL Stake Pool program deployed to devnet.
...
// Minimum amount of staked TRZ required in a validator stake account to allow
