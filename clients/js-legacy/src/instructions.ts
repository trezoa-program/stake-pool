...
/**
 * Withdraw trz instruction params
 */
...
export class StakePoolInstruction {
   ...
   * using the tpl token metadata program for the pool token
   */
   ...
   * in the tpl token metadata program account for the pool token
   */
  ...
  /**
   * Decode a deposit trz instruction and retrieve the instruction params.
   */
